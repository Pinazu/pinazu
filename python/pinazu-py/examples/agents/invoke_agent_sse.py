    ...
    message = client.create_message(
        ...
        message={
            ...
            "content": [
                {
                    "type": "text",
                    "text": "Use all the current tools for demonstrate please. No use parallel. Each tool must be executed once at a time. All the tools must be use twice event if the frist call is error or not. ALL two must use second time.",  # noqa: E501
                }
            ],
        },
